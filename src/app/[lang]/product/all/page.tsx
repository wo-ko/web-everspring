    ...
    <section className="min-h-screen bg-gray-50/50 py-12 sm:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 border-b border-gray-200 pb-8">
          ...
          <button
            onClick={() => setSortOrder(sortOrder === "asc" ? "desc" : "asc")}
            className="group flex items-center gap-2 bg-white border border-gray-200 px-5 py-2.5 rounded-full shadow-sm  hover:border-blue-400 transition-all duration-200 text-gray-700 font-medium"
          >
