...
const Footer = () => {
  ...
  return (
    <footer className={`${notoSansThai.className} bg-white pt-20 pb-10`}>
      <div className='max-w-screen-xl mx-auto px-6'>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16'>
          {/* Company Info */}
          <div className='lg:col-span-2 space-y-8'>
        ...
        <div className='max-w-screen-xl mx-auto px-6'>
          <div className='pt-10 flex flex-col md:flex-row justify-between items-center gap-8'>
            ...
            <div className='group relative order-1 md:order-2'>
              ...
              >
                <div className='flex items-center justify-center w-12 h-12 rounded-xl bg-gray-50 transition-colors duration-500 group-hover:bg-opacity-10'>
                  <style jsx>{`
                    .group:hover .stats-icon {
                      color: ${themeColor1 || '#0286C2'};
                    }
                ...
                <div className='ml-2 pl-6 border-l border-gray-100 hidden sm:block'>
                  <Globe className='w-5 h-5 text-gray-200 group-hover:rotate-[15deg] transition-all duration-700' />
                </div>
              </div>
            </div>
          </div>
