...
const sampleActivities = [
  ...
  {
    id: 2,
    imageUrl: 'http://anubandamnoen.com/_files_school/70102030/data/70102030_0_20210212-195024.jpg', 
...
export default function Peess() {
 ...
 return (
    <div>
      <main>
        <ActivitiesSection titles={'ข่าวสาร/กิจกรรม'} activities={sampleActivities} />
      </main>
    </div>
  );
}
